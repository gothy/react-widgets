...
describe('Select', function(){
  ...
  it('should respect textField and valueFields', function(){
    var select = render(<Select value={[0]} data={dataList} onChange={_.noop} textField='label' valueField='id' />)
      , tags   = findType(select, TagList).getDOMNode();
  ...
  it('should start closed', function(done){
    var select = render(<Select value={[0]} data={dataList} textField='label' valueField='id' onChange={_.noop}/>);
  ...
  it('should open when clicked', function(done){
    var select = render(<Select value={['jimmy']} data={dataList} duration={0} onChange={_.noop}/>);
    var popup = findType(select, require('../src/popup/popup.jsx'))
  ...
  it('should do nothing when disabled', function(done){
    var select = render(<Select value={['jimmy']} data={dataList} duration={0} disabled={true} onChange={_.noop}/>)
  ...
  it('should disable only certain tags', function(done){
    var select = render(<Select value={[0,1]} data={dataList} disabled={[1]} onChange={_.noop} textField='label' valueField='id'/>)
      , input  = findType(select, require('../src/select/search-input.jsx')).getDOMNode()
      , tags   = findType(select, TagList).getDOMNode();
  ...
  it('should do nothing when readonly', function(done){
    var select = render(<Select value={['jimmy']} data={dataList} duration={0} readOnly={true} onChange={_.noop}/>)
      , input  = findType(select, require('../src/select/search-input.jsx')).getDOMNode()
      , tags   = findType(select, TagList).getDOMNode();
  ...
  it('should readonly only certain tags', function(done){
    var select = render(<Select value={[0,1]} data={dataList} readOnly={[1]}  textField='label' valueField='id' onChange={_.noop}/>)
      , input  = findType(select, require('../src/select/search-input.jsx')).getDOMNode()
      , tags   = findType(select, TagList).getDOMNode();
